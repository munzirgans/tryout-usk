...
@section("content")
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{route('courier.update',$u->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @if($errors->any())
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="fullname" class="form-control" id="fullname" value="{{$u->fullname}}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="handphone" class="form-control" id="handphone" value="{{$u->handphone}}">
                </div>
                <div class="form-group">
