...
<head>
    ...
    <title>Login Account | Munzir's Food</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="{{route('login.login')}}">
                                        @csrf
                                        @if($message != "")
                                            <p class="text-danger ml-1" style="font-size:13px;">{{$message}}</p>
                                        @endif
                                        ...
                                        <button href="{{route('login.login')}}" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </button>
                                        <hr>
                                    </form>
